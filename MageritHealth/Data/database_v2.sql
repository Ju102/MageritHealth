...
VALUES 
(1, 'Julio Alejandro', 'Ordoñez', 'Rimacuna', '51234567A', '2002-07-10', '612345678', 'masculino', 'Ave del Paraíso 7, 1ºC Madrid', 'julioalejandro.ordonez@magerithealth.com', 'EqfW9WfXrX', 'admin', NULL, NULL, NULL, 1, NULL),
(2, 'Jean Carlo', 'Ordoñez', 'Rimacuna', '51234567B', '2004-01-08', '698765432', 'masculino', 'Ave del Paraíso 7, 1ºC Madrid', 'jeancarlo.ordonez@magerithealth.com', 'y1rw8j3h9Z', 'admin', NULL, NULL, NULL, 1, NULL),
(3, 'Patricia', 'Muñoz', 'García', '59876543B', '2003-03-15', '643597452', 'femenino', 'Antonio Conde 18, 2ºA Fuenlabrada', 'patricia.munozgarcia@magerithealth.com', 'H@0wv7e-4f', 'doctor', 1, 'COL-29336', NULL, 1, NULL),
(4, 'John', 'Smith', NULL, 'X2335624G', '1990-10-10', '697631548', 'masculino', 'Gran Vía 18, 2ªA, Madrid', 'john.smith@magerithealth.com', 'tkhGkXvtks', 'paciente', NULL, NULL, 'ASEG-068', 1, NULL),
(5, 'Carlos', 'García', 'Ruiz', '12345678A', '2011-11-11', '697654315', 'masculino', 'Desengaño 21, 1ºDCHA, 28006 Madrid', 'carlos.garciaruiz@magerithealth.com', 'kXLX26o5GI', 'paciente', NULL, NULL, 'ASEG-999', 1, NULL),
(6, 'Ángela', 'Fernández', 'Madrid', '59876543G', '1990-02-15', '673564215', 'femenino', 'Antigua Via de Fuenlabra 2ºC, 23044 Madrid', 'angela.fernandezmadrid@magerithealth.com', 'g3W_X*H-fy', 'doctor', 2, 'COL-29342', NULL, 1, NULL),
(7, 'Germán', 'Palomares', 'Pizarro', '56976532A', '1970-09-06', '631697513', 'masculino', 'Ave del Paraíso 7 2ºC, 28042 Madrid', 'german.palomares@magerithealth.com', 'U71Z7RQXNP', 'paciente', NULL, NULL, 'ASEG-124', 1, NULL);
...
-- ==========================================
INSERT INTO PRESCRIPCIONES (IdPrescripcion, IdCita, IdMedicamento, Instrucciones, FechaInicio, FechaFin, FechaCreacion)
VALUES 
(1, 1, 1, 'Tomar 1 comprimido cada 8 horas si hay dolor.', 2026-03-20, 2026-03-25, null),
(2, 2, 4, 'Tomar 5ml cada 8 horas en caso de fiebre post-vacuna.', 2026-03-22, 2026-03-24, null);
...
-- ==========================================
INSERT INTO INFO_CLINICA_PACIENTES (IdInfoClinica, IdPaciente, GrupoSanguineo, PesoActual, PesoNacimiento, ContactoEmergenciaNombre, ContactoEmergenciaTelefono)
VALUES 
(1, 4, 'A+',90, NULL, 'Mary Smith', '611223344'),
(2, 5, 'O-', 90, 3.20, 'Luisa Ruiz', '699887766'),
(3, 7, 'B+', 90, NULL, 'Elena Pizarro', '655443322');
...
select * from CREDENCIALES where IdUsuario = 5
select * from CITAS where IdPaciente = 5
select * from PRESCRIPCIONES
insert into CITAS values
(5,5,6,'Test 2 de cita futura', 10/12/2026, 'Test 4', 'programada', null, 1),
(2,5,6,'Test 1 de cita pasada', 11/12/2025, 'Test 1', 'completada', null, 0),
(3,5,6,'Test 2 de cita pasada', 10/09/2025, 'Test 2', 'completada', null, 0),
(4,5,6,'Test 3 de cita pasada', 01/01/2025, 'Test 3', 'completada', null, 0)

select * from CITAS where IdCita = 2

insert into PRESCRIPCIONES (IdPrescripcion, IdCita, IdMedicamento, Instrucciones, FechaInicio, FechaFin, Activa, FechaCreacion) values
(1, 2, 1, 'Prueba de medicación', getdate(), '2030-01-01', 1, getdate())